                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" 
                                        placeholder="Digite o nome do cliente" value="{{$client->name}}">
                                </div>

                                <div class="form-group">
                                    <label for="cnpj">Cnpj Cliente*</label>
                                    <input class="form-control" type="text" name="cnpj" 
                                        placeholder="Digite o cnpj do cliente"  value="{{$client->cnpj}}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="responsible_general_name" 
                                        placeholder="Digite o nome do responsável geral" value="{{$client->responsible_general_name}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="responsible_general_phone" 
                                        placeholder="Digite o telefone do responsável geral" value="{{$client->responsible_general_phone}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="technical_manager_name" 
                                        placeholder="Digite o nome do responsável Técnico" value="{{$client->technical_manager_name}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="technical_manager_phone" 
                                        placeholder="Digite o telefone do responsável técnico" value="{{$client->technical_manager_phone}}"
                                        onkeyup="mascara('(##)#####-####',this,event,true)" maxlength="14">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="cepInput" type="text" name="cep" placeholder="Digite o cep do cliente"
                                        onkeyup="mascara('#####-###',this,event,true)" maxlength="9" value="{{$client->cep}}">
                                </div>

                                <div class="form-group">
                                    <label for="street">Rua</label>
                                    <input class="form-control" type="text" name="street" 
                                        placeholder="Digite a rua do cliente" value="{{$client->street}}">
                                </div>

                                <div class="form-group">
                                    <label for="number">Numero</label>
                                    <input class="form-control" type="number" name="number" 
                                        placeholder="Digite o numero do cliente" value="{{$client->number}}">
                                </div>

                                <div class="form-group">
                                    <label for="neighboorhood">Bairro</label>
                                    <input class="form-control" type="text" name="neighboorhood" 
                                        placeholder="Digite o bairro do cliente" value="{{$client->neighboorhood}}">
                                </div>

                                <div class="form-group">
                                    <label for="state">Cidade</label>
                                    <input class="form-control" type="text" name="state" 
                                        placeholder="Digite o estado do cliente" value="{{$client->state}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="financial_officer_name" 
                                        ...
                                        value="{{$client->financial_officer_name}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="financial_officer_phone" 
                                        placeholder="Digite o telefone do responsável financeiro" 
                                        value="{{$client->financial_officer_phone}}"
                                        onkeyup="mascara('(##)#####-####',this,event,true)" maxlength="14">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="contact_monitoring_name" 
                                        ...
                                        value="{{$client->contact_monitoring_name}}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="contact_monitoring_phone" 
                                        ...
                                        onkeyup="mascara('(##)#####-####',this,event,true)" maxlength="14"
                                        value="{{$client->contact_monitoring_phone}}">
                                </div>
                                <div class="form-group">
